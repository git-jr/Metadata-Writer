...
class AssociatedFileMd:
  ...
  Attributes:
    ...
    [1]:
      https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L77
    [2]:
      https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L154
  """
...
class RegexTokenizerMd:
  ...
  [1]:
    https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L459
  """
...
class BertTokenizerMd:
  ...
  [1]:
    https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L436
  """
...
class SentencePieceTokenizerMd:
  ...
  [1]:
    https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L473
  """
...
class ScoreCalibrationMd:
  ...
  [1]:
    https://github.com/tensorflow/tflite-support/blob/5e0cdf5460788c481f5cd18aab8728ec36cf9733/tflite_support/metadata/metadata_schema.fbs#L434
  """
  ...
  def __init__(self,
    ...
    Args:
      ...
      [1]:
        https://github.com/tensorflow/tflite-support/blob/5e0cdf5460788c481f5cd18aab8728ec36cf9733/tflite_support/metadata/metadata_schema.fbs#L122
...
class TensorMd:
  ...
  Attributes:
    ...
    [2]:
      https://github.com/tensorflow/tflite-support/blob/b2a509716a2d71dfff706468680a729cc1604cff/tflite_support/metadata/metadata_schema.fbs#L595-L612
  """
...
class InputImageTensorMd(TensorMd):
  ...
  Attributes:
    ...
    [2]:
      https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L172
  """
  ...
  def __init__(self,
    ...
    Args:
      ...
      tokenizer_md: information of the tokenizer in the input text tensor, if
        ...
        [1]:
        https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L475
        [2]:
        https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L436
        [3]:
        https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L473
...
class ClassificationTensorMd(TensorMd):
  ...
  Attributes:
    ...
    [1]:
      https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L95
    [2]:
      https://github.com/tensorflow/tflite-support/blob/5e0cdf5460788c481f5cd18aab8728ec36cf9733/tflite_support/metadata/metadata_schema.fbs#L434
  """
...
class CategoryTensorMd(TensorMd):
  ...
  def __init__(self,
    ...
    Args:
      ...
      [1]:
        https://github.com/tensorflow/tflite-support/blob/b80289c4cd1224d0e1836c7654e82f070f9eefaa/tflite_support/metadata/metadata_schema.fbs#L108
    """
